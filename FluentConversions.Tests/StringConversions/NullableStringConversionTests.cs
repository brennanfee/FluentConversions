    ...
    public static class NullableStringConversionTests
    {
        ...
        public class CurrencyTests
        {
            ...
            public void BaseUsesCurrentCulture()
            {
                ...
                {
                    var result = Number.ConvertToNullable().Currency();
            ...
            {
                var result = string.Empty.ConvertToNullable().Currency();
                result.HasValue.Should().BeFalse();
            }
            ...
            public void BaseRoundsToCultureLength()
            {
                ...
                using (new CultureInfoScope("sv-SE"))
                {
                    var result = Number.ConvertToNullable().Currency(true);
            ...
            public void PassedCulturePasses()
            {
                ...
                var result = Number.ConvertToNullable().Currency(CultureInfo.GetCultureInfo("sv-SE"));
            ...
            {
                var result = string.Empty.ConvertToNullable().Currency(CultureInfo.GetCultureInfo("sv-SE"));
                result.HasValue.Should().BeFalse();
            }
            ...
            public void PassedCultureRounds()
            {
                ...
                var result = Number.ConvertToNullable().Currency(CultureInfo.GetCultureInfo("sv-SE"), true);
            ...
            public void InvariantPasses()
            {
                ...
                var result = Number.ConvertToNullable().CurrencyInvariant();
            ...
            {
                var result = string.Empty.ConvertToNullable().CurrencyInvariant();
                result.HasValue.Should().BeFalse();
            }
            ...
            public void InvariantRounds()
            {
                ...
                var result = Number.ConvertToNullable().CurrencyInvariant(true);
            ...
            public void CulturePasses()
            {
                ...
                {
                    var result = Number.ConvertToNullable().CurrencyCulture();
            ...
            {
                var result = string.Empty.ConvertToNullable().CurrencyCulture();
                result.HasValue.Should().BeFalse();
            }
            ...
            public void CultureRounds()
            {
                ...
                using (new CultureInfoScope("en-US"))
                {
                    var result = Number.ConvertToNullable().CurrencyCulture(true);
